...
SEXP cyst_generator_create(SEXP user, SEXP odin_use_dde) {
  ...
  cyst_generator_p->CCC0 = NA_REAL;
  cyst_generator_p->CTC0 = NA_REAL;
  ...
  cyst_generator_p->RR_cysticercosis = NA_REAL;
...
SEXP cyst_generator_set_user(cyst_generator_pars *cyst_generator_p, SEXP user) {
  ...
  cyst_generator_p->CCC0 = get_user_double(user, "CCC0", cyst_generator_p->CCC0);
  cyst_generator_p->CTC0 = get_user_double(user, "CTC0", cyst_generator_p->CTC0);
  ...
  cyst_generator_p->RR_cysticercosis = get_user_double(user, "RR_cysticercosis", cyst_generator_p->RR_cysticercosis);
  return R_NilValue;
}
...
SEXP cyst_generator_initialise(SEXP cyst_generator_ptr, SEXP t_ptr) {
  ...
  cyst_generator_p->initial_CCC = cyst_generator_p->CCC0;
  cyst_generator_p->initial_CTC = cyst_generator_p->CTC0;
  SEXP state = PROTECT(allocVector(REALSXP, 12));
  ...
  REAL(state)[10] = cyst_generator_p->initial_CCC;
  REAL(state)[11] = cyst_generator_p->initial_CTC;
...
void cyst_generator_deriv(cyst_generator_pars *cyst_generator_p, double t, double *state, double *dstatedt, double *output) {
  ...
  dstatedt[1] = (cyst_generator_p->pil * cyst_generator_p->chi) * SH * IPL / cyst_generator_p->PPS + (cyst_generator_p->pih * cyst_generator_p->chi) * SH * IPH / cyst_generator_p->PPS - cyst_generator_p->alpha * IH - cyst_generator_p->theta * (1 + cyst_generator_p->RR_cysticercosis) * IH * E - cyst_generator_p->dH * IH;
  ...
  dstatedt[3] = (cyst_generator_p->pil * cyst_generator_p->chi) * SHC * IPL / cyst_generator_p->PPS + (cyst_generator_p->pih * cyst_generator_p->chi) * SHC * IPH / cyst_generator_p->PPS + cyst_generator_p->theta * (1 + cyst_generator_p->RR_cysticercosis) * IH * E - cyst_generator_p->alpha * IHC - cyst_generator_p->eta * IHC - cyst_generator_p->dH * IHC;
  ...
  dstatedt[10] = cyst_generator_p->theta * (1 + cyst_generator_p->RR_cysticercosis) * IH * E + cyst_generator_p->theta * SH * E;
  dstatedt[11] = (cyst_generator_p->pil * cyst_generator_p->chi) * SH * IPL / cyst_generator_p->PPS + (cyst_generator_p->pil * cyst_generator_p->chi) * SHC * IPL / cyst_generator_p->PPS + (cyst_generator_p->pih * cyst_generator_p->chi) * SH * IPH / cyst_generator_p->PPS + (cyst_generator_p->pih * cyst_generator_p->chi) * SHC * IPH / cyst_generator_p->PPS;
  if (output != NULL) {
    output[0] = IH + IHC;
    output[1] = SHC + IHC;
    output[2] = IPH + IPL;
...
SEXP cyst_generator_contents(SEXP cyst_generator_ptr) {
  cyst_generator_pars *cyst_generator_p = cyst_generator_get_pointer(cyst_generator_ptr, 1);
  SEXP state = PROTECT(allocVector(VECSXP, 43));
  ...
  SET_VECTOR_ELT(state, 12, ScalarReal(cyst_generator_p->CCC0));
  SET_VECTOR_ELT(state, 13, ScalarReal(cyst_generator_p->CTC0));
  SET_VECTOR_ELT(state, 14, ScalarReal(cyst_generator_p->HPS));
  SET_VECTOR_ELT(state, 15, ScalarReal(cyst_generator_p->PPS));
  SET_VECTOR_ELT(state, 16, ScalarReal(cyst_generator_p->dH));
  SET_VECTOR_ELT(state, 17, ScalarReal(cyst_generator_p->dP));
  SET_VECTOR_ELT(state, 18, ScalarReal(cyst_generator_p->bH));
  SET_VECTOR_ELT(state, 19, ScalarReal(cyst_generator_p->bP));
  SET_VECTOR_ELT(state, 20, ScalarReal(cyst_generator_p->dE));
  SET_VECTOR_ELT(state, 21, ScalarReal(cyst_generator_p->delta));
  SET_VECTOR_ELT(state, 22, ScalarReal(cyst_generator_p->theta));
  SET_VECTOR_ELT(state, 23, ScalarReal(cyst_generator_p->phi));
  SET_VECTOR_ELT(state, 24, ScalarReal(cyst_generator_p->alpha));
  SET_VECTOR_ELT(state, 25, ScalarReal(cyst_generator_p->eta));
  SET_VECTOR_ELT(state, 26, ScalarReal(cyst_generator_p->pil));
  SET_VECTOR_ELT(state, 27, ScalarReal(cyst_generator_p->chi));
  SET_VECTOR_ELT(state, 28, ScalarReal(cyst_generator_p->pih));
  SET_VECTOR_ELT(state, 29, ScalarReal(cyst_generator_p->epsilon));
  SET_VECTOR_ELT(state, 30, ScalarReal(cyst_generator_p->RR_cysticercosis));
  SET_VECTOR_ELT(state, 31, ScalarReal(cyst_generator_p->initial_SH));
  SET_VECTOR_ELT(state, 32, ScalarReal(cyst_generator_p->initial_IH));
  SET_VECTOR_ELT(state, 33, ScalarReal(cyst_generator_p->initial_SHC));
  SET_VECTOR_ELT(state, 34, ScalarReal(cyst_generator_p->initial_IHC));
  SET_VECTOR_ELT(state, 35, ScalarReal(cyst_generator_p->initial_E));
  SET_VECTOR_ELT(state, 36, ScalarReal(cyst_generator_p->initial_SP));
  SET_VECTOR_ELT(state, 37, ScalarReal(cyst_generator_p->initial_IPL));
  SET_VECTOR_ELT(state, 38, ScalarReal(cyst_generator_p->initial_IPH));
  SET_VECTOR_ELT(state, 39, ScalarReal(cyst_generator_p->initial_RP));
  SET_VECTOR_ELT(state, 40, ScalarReal(cyst_generator_p->initial_VP));
  SET_VECTOR_ELT(state, 41, ScalarReal(cyst_generator_p->initial_CCC));
  SET_VECTOR_ELT(state, 42, ScalarReal(cyst_generator_p->initial_CTC));
  SEXP state_names = PROTECT(allocVector(STRSXP, 43));
  ...
  SET_STRING_ELT(state_names, 12, mkChar("CCC0"));
  SET_STRING_ELT(state_names, 13, mkChar("CTC0"));
  SET_STRING_ELT(state_names, 14, mkChar("HPS"));
  SET_STRING_ELT(state_names, 15, mkChar("PPS"));
  SET_STRING_ELT(state_names, 16, mkChar("dH"));
  SET_STRING_ELT(state_names, 17, mkChar("dP"));
  SET_STRING_ELT(state_names, 18, mkChar("bH"));
  SET_STRING_ELT(state_names, 19, mkChar("bP"));
  SET_STRING_ELT(state_names, 20, mkChar("dE"));
  SET_STRING_ELT(state_names, 21, mkChar("delta"));
  SET_STRING_ELT(state_names, 22, mkChar("theta"));
  SET_STRING_ELT(state_names, 23, mkChar("phi"));
  SET_STRING_ELT(state_names, 24, mkChar("alpha"));
  SET_STRING_ELT(state_names, 25, mkChar("eta"));
  SET_STRING_ELT(state_names, 26, mkChar("pil"));
  SET_STRING_ELT(state_names, 27, mkChar("chi"));
  SET_STRING_ELT(state_names, 28, mkChar("pih"));
  SET_STRING_ELT(state_names, 29, mkChar("epsilon"));
  SET_STRING_ELT(state_names, 30, mkChar("RR_cysticercosis"));
  SET_STRING_ELT(state_names, 31, mkChar("initial_SH"));
  SET_STRING_ELT(state_names, 32, mkChar("initial_IH"));
  SET_STRING_ELT(state_names, 33, mkChar("initial_SHC"));
  SET_STRING_ELT(state_names, 34, mkChar("initial_IHC"));
  SET_STRING_ELT(state_names, 35, mkChar("initial_E"));
  SET_STRING_ELT(state_names, 36, mkChar("initial_SP"));
  SET_STRING_ELT(state_names, 37, mkChar("initial_IPL"));
  SET_STRING_ELT(state_names, 38, mkChar("initial_IPH"));
  SET_STRING_ELT(state_names, 39, mkChar("initial_RP"));
  SET_STRING_ELT(state_names, 40, mkChar("initial_VP"));
  SET_STRING_ELT(state_names, 41, mkChar("initial_CCC"));
  SET_STRING_ELT(state_names, 42, mkChar("initial_CTC"));
...
SEXP cyst_generator_variable_order(SEXP cyst_generator_ptr) {
  SEXP state_len = PROTECT(allocVector(VECSXP, 12));
  SEXP state_names = PROTECT(allocVector(STRSXP, 12));
  ...
  SET_STRING_ELT(state_names, 10, mkChar("CCC"));
  SET_VECTOR_ELT(state_len, 11, R_NilValue);
  SET_STRING_ELT(state_names, 11, mkChar("CTC"));
