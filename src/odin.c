// Automatically generated by odin 1.5.12 - do not edit
#include <float.h>
#include <R.h>
#include <Rmath.h>
...
void cyst_generator_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    R_Free(internal->age_rate_human);
    R_Free(internal->age_rate_pig);
    R_Free(internal->IH0);
    R_Free(internal->IHC0);
    R_Free(internal->initial_IH);
    R_Free(internal->initial_IHC);
    R_Free(internal->initial_IPH);
    R_Free(internal->initial_IPL);
    R_Free(internal->initial_PP);
    R_Free(internal->initial_RP);
    R_Free(internal->initial_SH);
    R_Free(internal->initial_SHC);
    R_Free(internal->initial_SP);
    R_Free(internal->initial_VP);
    R_Free(internal->IPH0);
    R_Free(internal->IPL0);
    R_Free(internal->PP0);
    R_Free(internal->RP0);
    R_Free(internal->SH0);
    R_Free(internal->SHC0);
    R_Free(internal->SP0);
    R_Free(internal->VP0);
    R_Free(internal);
...
SEXP cyst_generator_create(SEXP user) {
  cyst_generator_internal *internal = (cyst_generator_internal*) R_Calloc(1, cyst_generator_internal);
...
SEXP cyst_generator_set_user(SEXP internal_p, SEXP user) {
  ...
  R_Free(internal->initial_IH);
  internal->initial_IH = (double*) R_Calloc(internal->dim_IH, double);
  R_Free(internal->initial_IHC);
  internal->initial_IHC = (double*) R_Calloc(internal->dim_IHC, double);
  R_Free(internal->initial_IPH);
  internal->initial_IPH = (double*) R_Calloc(internal->dim_IPH, double);
  R_Free(internal->initial_IPL);
  internal->initial_IPL = (double*) R_Calloc(internal->dim_IPL, double);
  R_Free(internal->initial_PP);
  internal->initial_PP = (double*) R_Calloc(internal->dim_PP, double);
  R_Free(internal->initial_RP);
  internal->initial_RP = (double*) R_Calloc(internal->dim_RP, double);
  R_Free(internal->initial_SH);
  internal->initial_SH = (double*) R_Calloc(internal->dim_SH, double);
  R_Free(internal->initial_SHC);
  internal->initial_SHC = (double*) R_Calloc(internal->dim_SHC, double);
  R_Free(internal->initial_SP);
  internal->initial_SP = (double*) R_Calloc(internal->dim_SP, double);
  R_Free(internal->initial_VP);
  internal->initial_VP = (double*) R_Calloc(internal->dim_VP, double);
...
SEXP cyst_generator_metadata(SEXP internal_p) {
  ...
  SET_STRING_ELT(output_names, 9, mkChar("pig_deaths"));
  SET_VECTOR_ELT(ret, 1, output_length);
  UNPROTECT(2);
  SET_VECTOR_ELT(ret, 2, ScalarInteger(10));
  UNPROTECT(2);
  return ret;
}
SEXP cyst_generator_initial_conditions(SEXP internal_p, SEXP t_ptr) {
...
void cyst_generator_rhs(cyst_generator_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  if (output) {
    ...
    output[9] = (internal->dP * odin_sum1(SP, 0, internal->na_pig)) + (internal->dP * odin_sum1(PP, 0, internal->na_pig)) + (internal->dP * odin_sum1(IPL, 0, internal->na_pig)) + (internal->dP * odin_sum1(IPH, 0, internal->na_pig)) + (internal->dP * odin_sum1(RP, 0, internal->na_pig)) + (internal->dP * odin_sum1(VP, 0, internal->na_pig)) + (internal->dPslg * odin_sum1(SP, internal->slgage_foi - 1, internal->na_pig)) + (internal->dPslg * odin_sum1(PP, internal->slgage_foi - 1, internal->na_pig)) + (internal->dPslg * odin_sum1(IPL, internal->slgage_foi - 1, internal->na_pig)) + (internal->dPslg * odin_sum1(IPH, internal->slgage_foi - 1, internal->na_pig)) + (internal->dPslg * odin_sum1(RP, internal->slgage_foi - 1, internal->na_pig)) + (internal->dPslg * odin_sum1(VP, internal->slgage_foi - 1, internal->na_pig));
...
SEXP cyst_generator_rhs_r(SEXP internal_p, SEXP t, SEXP state) {
  ...
  cyst_generator_internal *internal = cyst_generator_get_internal(internal_p, 1);
  SEXP output_ptr = PROTECT(allocVector(REALSXP, 10));
