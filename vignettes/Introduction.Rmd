...
knitr::kable(utils::tail(m1[, c(1,14:16)], 10), caption = 'Tracked cases', digits = 0)
knitr::kable(utils::tail(m1[, c(1,17:19)], 10), caption = 'Tracked prevalence', digits = 2)
```
