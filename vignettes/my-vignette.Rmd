...
# Call and view default parameters and equilibrium solutions
...
knitr::kable(M1[1:5, 1:11], caption = 'State variables')
knitr::kable(M1[1:5, 12:13], caption = 'Cumulative cases')
knitr::kable(M1[1:5, 14:16], caption = 'Tracked cases', digits=0)
knitr::kable(M1[1:5, 17:19], caption = 'Tracked prevalence', digits=0)
````
